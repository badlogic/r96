...
int main(void) {
	...
	do {
		...
		r96_font_get_text_bounds(&font, (char *) text, &text_width, &text_height);
		...
		r96_text_tinted(&output, &font, (char *) text, text_x + 1, text_y + 1, 0x0);
		r96_text(&output, &font, (char *) text, text_x, text_y);
